...
<!-- hero area -->
<div class="hero-area" style="background-image: url('<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full'); ?>'); background-size: cover;">
    <div class="container">
        <div class="row">
...
<div class="latest-news pt-150 pb-150">
    <div class="container">
		...
		<?php
		$fruits_homepage_post_per_page = get_option( 'fruits_homepage_post_per_page' );
        ...
        <div class="cxc-fruit-wrapper">
			...
			<?php
				$fruits_args = array(
					'post_type'      => 'fruit',
					'posts_per_page' => $fruits_homepage_post_per_page,
					'post_status'    => 'publish',
					'meta_query'     => array(
						'relation' => 'AND', // Ensure both meta queries are applied
						array(
							'key'     => 'fruit_category',
							'value'   => array('Strawberry', 'Kiwi'), // Include only Strawberry and Kiwi categories
							'compare' => 'IN', // Match posts with either Strawberry or Kiwi category
						),
						array(
							'key'     => 'imported',
							'value'   => 1,
							'compare' => '=', // Check if imported is 1
							'type'    => 'NUMERIC', // Assuming 'imported' is a numeric value
						),
					),
				);
